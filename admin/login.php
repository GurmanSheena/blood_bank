...
<body background-color="admin_image/image.jpg">
  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:200px;">
      <div class="row justify-content-center">
          <div class="col-lg-6">
              <h1 class="mt-4 mb-3" style="color:blue ;">
      ...
      <div class="card" style="height:250px; background-image:url('admin_image/donate.jpg');">
          <div class="card-body">
