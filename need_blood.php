...
<body>
  ...
  <div class="row">
      <div class="col-lg-6">
          <h1 class="mt-4 mb-3">Co you Need Blood</h1>
...
<div class="col-lg-4 mb-4">
<div class="font-italic">Please give reason, why do you need blood?<span style="color:red">*</span></div>
...
<?php if(isset($_POST['search'])){
  ...
  <?php
    ...
    else
    {
        ...
        echo '<div class="alert alert-danger">No Donor is found for the required blood type </div>';
